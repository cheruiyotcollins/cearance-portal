package com.clearance.gigster.service;


import com.clearance.gigster.model.hod.ClearanceStatus;
import com.clearance.gigster.model.hod.GraduationList;
import com.clearance.gigster.model.records.Gown;
import com.clearance.gigster.model.student.Confirmation;
import com.clearance.gigster.model.student.ConfirmationStatus;
...
import com.clearance.gigster.repository.graduation.GraduationListRepository;
import com.clearance.gigster.repository.records.GownRepository;
import com.clearance.gigster.repository.student.ConfirmationRepository;
                 ...
                 new Thread(new Runnable() {
                    public void run() {
                        ...
                        String emailBody = "Dear " + studentRepository.findById(gown.getStudentId()).get().getName() + "," + "\n" + "\n" + "Please clear the gown issued to you within the next two days with the records department" +
                                ...
                                + "\n\n" + "Regards" + "\n" + "Gigster University Records Department";
            ...
            if (graduation.getFinanceClearance().equals(ClearanceStatus.CLEARED)) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        String emailBody = "Dear " + studentRepository.findById(id).get().getName() + "," + "\n" + "\n" + "You have been issued a gown by the records department. Kindly log in to Gigster ERP portal to confirm receipt.\n" +
            ...
            generalResponse.description = "Gown Cleared Successfully";
             new Thread(new Runnable() {
                public void run() {
                    ...
                    String emailBody = "Dear " + studentRepository.findById(id).get().getName() + "," + "\n" + "\n" + "A gown issued to you has been cleared, kindly log in to Gigster graduation portal to confirm clearance.\n"
                            + "\n\n" + "Regards" + "\n" + "Gigster University Records Department";
