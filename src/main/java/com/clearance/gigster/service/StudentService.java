...
public class StudentService {
    ...
    public GraduationListResponse viewGraduationNames(Long id) {
        GraduationList graduation= graduationListRepository.findByStudent(studentRepository.findByUserId(id));
    ...
    public ResponseEntity<?> confirmGraduationName(UserPrincipal userPrincipal,ConfirmGraduationNameRequest confirm) {
        generalResponse = new GeneralResponse();
        try {
