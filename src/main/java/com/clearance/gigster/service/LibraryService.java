...
import com.clearance.gigster.model.library.BookStatus;
...
import com.clearance.gigster.repository.library.LibraryRepository;
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        String emailBody = "Dear " + gown.getStudent().getName() + "," + "\n" + "\n" + "Please return a book("+bookRepository.findById(gown.getBookId()).get().getBookName()+") issued to within the next day library department" +
                                ...
                                + "\n\n" + "Regards" + "\n" + "Gigster University Library Department";
