...
import com.clearance.gigster.repository.finance.FinanceRepository;
import com.clearance.gigster.repository.finance.PaymentsRepository;
...
public class FinanceService {
    ...
    public ResponseEntity<?> findFeeBalanceById(Long id) {
        Finance finance= financeRepository.findByStudentId(studentRepository.findById(id).get());

        return new ResponseEntity(setRespomse(finance), HttpStatus.ACCEPTED) ;

    }
    public ResponseEntity<?> findStudentPayments(Long id) {
        List<Payment> payments= paymentsRepository.findByStudentId(id);
