...
import { checkStudentRegistrationStatus, makePayment } from "../util/APIUtils";
import "./Payment.css";
        ...
        <div className="signup-content">
          <Form onSubmit={this.handleSubmit} className="signup-form">
              ...
              <form className="signup-form">
                <label>
                  ...
                  <select id="dropdown" onChange={this.handleDropdownChange}>
                    ...
                    <option value="2">Graduation Fee</option>
                  </select>
                </label>
              </form>
            </div>
            ...
            <FormItem>
              ...
              Already registed?{" "}
              <Link to="/student/list">Go back to payment records!</Link>
            </FormItem>
          </Form>
        </div>
      </div>
